...
<div class="app-sidebar__overlay" data-toggle="sidebar"></div>
  <aside class="app-sidebar">
    ...
    <ul class="app-menu">
      ...
      <li class="treeview <?=($menu_ativo == "curso") ? "is-expanded" : "" ?>"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-edit"></i><span class="app-menu__label">Cursos</span><i class="treeview-indicator fa fa-angle-right"></i></a>
        <ul class="treeview-menu">
          <li><a class="treeview-item <?=(($submenu_ativo == "c_cad") ? "active" : "")?>" href="<?=base_url("curso_insert")?>"><i class="icon fa fa-circle-o"></i> Cadastrar</a></li>
          <li><a class="treeview-item <?=(($submenu_ativo == "c_list") ? "active" : "")?>" href="<?=base_url("curso_list");?>"><i class="icon fa fa-circle-o"></i> Listar</a></li>
        </ul>
      </li>
      ...
      <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-id-card-o"></i><span class="app-menu__label">Inscrições</span><i class="treeeview-indicator fa fa-angle-right"></i></a>
        <ul class="treeview-menu">
          <li><a class="treeview-item <?=($submenu_ativo == "i_cad") ? "active" : ""?>" href="<?=base_url()?>"><i class="icon fa fa-circle-o"></i> Cadastrar</a></li>
          <li><a class="treeview-item <?=($submenu_ativo == "i_list") ? "active" : ""?>" href="<?=base_url()?>"><i class="icon fa fa-circle-o"></i> Listar</a></li>
        </ul>
      </li>
    </ul>
  </aside>