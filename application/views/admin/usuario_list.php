                        ...
                        if(isset($usuario_dados)){
                            foreach ($usuario_dados as $user) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="col-4">
                                            <form class="col-2" method="post" action="<?=base_url('user_update');?>">
                                            ...
                                            <div class="col-2">
                                            <button type="button" data-toggle="modal" data-target="#excluirUsuario_<?=$user->id;?>" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i> Excluir</button>
                                            </div>
                                            <!-- Modal-->
                                            <div id="excluirUsuario_<?=$user->id;?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
